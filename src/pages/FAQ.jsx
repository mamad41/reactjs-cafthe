    ...
    return (
        <div className="border-b border-gold-premium/10 dark:border-white/10 py-6 transition-all">
            ...
            >
                ...
                {isOpen ? <ChevronUp className="text-gold-premium" size={20} /> : <ChevronDown className="text-gray-400" size={20} />}
            </button>
        ...
        <main id="Faq" className="bg-white dark:bg-black min-h-screen py-24 px-[10vw] transition-colors duration-500">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-20">
                    ...
                    <div className="w-20 h-px bg-gold-premium mx-auto opacity-40 mb-4"></div>
                ...
                <div className="bg-card-bg dark:bg-surface-dark p-8 md:p-12 rounded-[40px] shadow-2xl border border-gold-premium/5">
                    {faqs.map((faq, index) => (
                ...
                <div className="mt-16 text-center">
                    ...
                    <Link to='/Contact#form'>
                        <button className="mt-6 text-gold-premium border border-gold-premium/30 px-8 py-3 rounded-full font-bold uppercase text-[10px] tracking-[4px] hover:bg-gold-premium hover:text-white transition-all duration-300">
                            Contacter un expert
                        </button>
                    </Link>
                </div>
