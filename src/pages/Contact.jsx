...
const Contact = () => {
    return (
        <main className="bg-[#FDFCF7] min-h-screen py-20 px-4 sm:px-10 font-forum">
            {/* --- HEADER --- */}
            <header className="max-w-300 mx-auto mb-20 text-center">
            ...
            <div className="max-w-300 mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-12">
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="flex items-center gap-6 group">
                                <div className="shrink-0 w-14 h-14 bg-white rounded-full shadow-sm border border-gray-100 flex items-center
                                justify-center transition-colors group-hover:border-gold-premium">
                    ...
                    <div id="form" className="lg:col-span-7 w-full h-full"> {/* Assure-toi qu'il n'y a pas de pb-32 ici qui fausse la vue */}
                        ...
                        <div id="Card" className="bg-white rounded-[20px] p-8 md:p-14 pb-20 shadow-sm border border-gray-100 box-border h-full">
                            ...
                            <form className="mx-auto flex flex-col h-full max-w-200">
                                ...
                                <div className="space-y-7 mb-16">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <input id="inp" type="text" className="w-full bg-[#FDFCF7] border border-gray-100 rounded-full px-6 py-4 outline-none
                                            focus:border-gold-premium font-sans text-sm" placeholder="Votre nom" />
                                        </div>
                                        <div className="flex flex-col gap-2">
                                            <label className="font-sans text-[10px] uppercase tracking-widest ml-4 text-gray-400 font-bold">Prénom</label>
                                            <input id="inp1" type="text" className="w-full bg-input-bg border border-gray-100 rounded-full px-6 py-4 outline-none
                                            focus:border-gold-premium font-sans text-sm" placeholder="Votre prénom" />
                                        </div>
                                    </div>

                                    <div className="flex flex-col gap-2">
                                        <label className="font-sans text-[10px] uppercase tracking-widest ml-4 text-gray-400 font-bold">Email</label>
                                        <input id="inp2" type="email" className="w-full bg-[#FDFCF7] border border-gray-100 rounded-full px-6 py-4 outline-none
                                        focus:border-gold-premium font-sans text-sm" placeholder="votre@email.com" />
                                    </div>

                                    <div className="flex flex-col gap-2">
                                        <label className="font-sans text-[10px] uppercase tracking-widest ml-4 text-gray-400 font-bold">Message</label>
                                        <textarea id="inp3" rows="5" className="w-full bg-[#FDFCF7] border border-gray-100 rounded-[20px] px-6 py-5 outline-none
                                        focus:border-gold-premium font-sans text-sm resize-none" placeholder="Comment pouvons-nous vous aider ?"></textarea>
                                    </div>
                                </div>
