    ...
    if (!isAuthenticated) {
        return (
            <main className="min-h-screen bg-input-bg flex items-center justify-center p-6 font-forum">
                <div id="Card" className="bg-white max-w-md w-full rounded-[40px] shadow-2xl p-12 text-center border border-gray-100">
                    ...
                    {activeTab === 'overview' && (
                        <div className="space-y-12 animate-fadeIn">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                                ...
                                {/* Résumé Rapide */}
                                <div className="bg-input-bg border border-gray-100 rounded-[40px] p-10 flex flex-col justify-center items-center text-center">
                    ...
                    {activeTab === 'profile' && (
                        <div className="space-y-16 animate-fadeIn">
                            ...
                            <section>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {addresses.map((addr) => (
                                        <div key={addr.id} className={`p-8 rounded-[35px] border transition-all relative group ${addr.isDefault ? 'border-gold-premium bg-white shadow-xl' : 'border-gray-100 bg-white/40'}`}>
