...
const PromoBanner = () => {
    ...
    return (
        <div className="relative bg-[#1a1a1a] border-b border-gold-premium/30 animate-slideDown z-0" role="alert" aria-live="polite">
            <div className="max-w-7xl mx-auto px-4 py-2 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between flex-nowrap">

                    {/* Message Central */}
                    <div className="flex-1 flex items-center justify-center">
                        <TicketPercent className="h-4 w-4 text-gold-premium mr-3 hidden sm:block" aria-hidden="true" />
                        ...
                        >
                            ...
                            {copied ? <Check size={10} className="text-green-400" aria-hidden="true" /> : <Copy size={10} className="text-white/30 group-hover:text-white" aria-hidden="true" />}
                        </button>
                    </div>
                    ...
                    >
                        <X className="h-4 w-4 text-white/20 hover:text-white" aria-hidden="true" />
                    </button>
                </div>
            </div>
        </div>
