...
const ScrollControls = () => {
    ...
    return (
        <div className="fixed bottom-8 right-8 z-100 flex flex-col gap-4" aria-label="Contrôles de défilement de la page">
            ...
            <div className={`relative transition-all duration-500 ${showTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
                ...
                <button
                    ...
                    aria-label={`Retour en haut de la page. Progression actuelle : ${Math.round(scrollProgress)}%`}
                >
        ...
        ${showBottom ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}
                aria-label="Aller tout en bas de la page"
            >
