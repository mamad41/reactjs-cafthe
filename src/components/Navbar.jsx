...
function Navbar() {
    ...
    // Classe pour le lien parent (le "group" est la clé ici)
    // 1. Le conteneur du lien devient un "onglet" au survol
...
// 2. La Pop-up vient se coller parfaitement sous l'onglet
    ...
    // Classe pour le texte avec soulignement au hover
            ...
            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '0px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '5px 60px', marginBottom: '0px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '25px' }}>
                        ...
                        <Link to="/panier" style={{ color: '#C5A059' }}><ShoppingBag size={22} /></Link>
                    </div>
                </div>
